...
CREATE TABLE accounts (
    ...
    acc_name VARCHAR(50) unique, 
    balance DECIMAL(10, 2) check (balance > 0)
);
INSERT INTO accounts (acc_id, acc_name, balance) VALUES('A001', 'Alice', 20000.00),('B001', 'Bob', 10000.00),('B002', 'Charlie', 8000.00);
	START TRANSACTION;
...
UPDATE accounts SET balance = balance + 5000 WHERE acc_id = 'B001';  -- This fails
...
UPDATE accounts SET balance = balance + 5000 WHERE acc_id = 'B002';
SELECT * FROM accounts; 
